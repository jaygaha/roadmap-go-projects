...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/register": {
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "User registered successfully. Please log in to continue.",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/workouts": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Workout Request",
                        "name": "createWorkoutRequest",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateWorkoutRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.WorkoutReportItem"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "models.Exercise": {
            ...
            "properties": {
                "category": {
                    "description": "e.g., Strength, Cardio, Flexibility",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
                ...
                "muscleGroup": {
                    "description": "e.g., Chest, Legs, Back",
                    "type": "string"
                },
                "name": {
                    "type": "string"
        ...
        "models.WorkoutReportItem": {
            "type": "object",
            "properties": {
                "exercises": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.ReportExercise"
                    }
                },
                "id": {
                    "type": "integer"
